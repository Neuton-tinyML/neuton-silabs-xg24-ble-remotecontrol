/**
 *
 * @defgroup neuton_dsp_statistic_absmean Absolute Mean
 * @{
 ...
 *
 */
#ifndef _NEUTON_DSP_STAT_ABSMEAN_FUNCTIONS_H_
#define _NEUTON_DSP_STAT_ABSMEAN_FUNCTIONS_H_
 ...
 *
 * @return  neuton_f32_t  Absolute Mean value of the vector
 */
 ...
 *                       this function will use <pre> p_ctx->value.sum </pre> for calculation if it exist
 *
 * @return  neuton_u8_t  Absolute Mean value of the vector
 */
 ...
 *                       this function will use <pre> p_ctx->value.sum </pre> for calculation if it exist
 *
 * @return  neuton_u16_t  Absolute Mean value of the vector
 */
...
#endif /* _NEUTON_DSP_STAT_ABSMEAN_FUNCTIONS_H_ */

/**
 *
 * @defgroup neuton_dsp_statistic_mean Mean
 * @{
 ...
 *
 */
#ifndef _NEUTON_DSP_STAT_MEAN_FUNCTIONS_H_
#define _NEUTON_DSP_STAT_MEAN_FUNCTIONS_H_
 ...
 *
 * @return  neuton_f32_t  Mean value of the vector
 */
 ...
 *                       this function will use <pre> p_ctx->value.sum </pre> for calculation if it exist
 *
 * @return  neuton_i8_t  Mean value of the vector
 */
 ...
 *                       this function will use <pre> p_ctx->value.sum </pre> for calculation if it exist
 *
 * @return  neuton_i16_t  Mean value of the vector
 */
 ...
 * 
 * @return  neuton_i32_t  Mean value of the vector
 */
...
#endif /* _NEUTON_DSP_STAT_MEAN_FUNCTIONS_H_ */
